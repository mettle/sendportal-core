...
class EmailServicesController extends Controller
{
    ...
    {
        $emailServices = $this->emailServices->all(Helper::getCurrentWorkspace()->id);
    ...
    public function store(EmailServiceStoreRequest $request): RedirectResponse
    {
        ...
        $this->emailServices->store(Helper::getCurrentWorkspace()->id, [
            'name' => $request->name,
    ...
    {
        $emailServiceTypes = $this->emailServices->getEmailServiceTypes()->pluck('name', 'id');
        $emailService = $this->emailServices->find(Helper::getCurrentWorkspace()->id, $emailServiceId);
    ...
    {
        $emailService = $this->emailServices->find(Helper::getCurrentWorkspace()->id, $emailServiceId, ['type']);
    ...
    {
        $emailService = $this->emailServices->find(Helper::getCurrentWorkspace()->id, $emailServiceId, ['campaigns']);
        ...
        $this->emailServices->destroy(Helper::getCurrentWorkspace()->id, $emailServiceId);
