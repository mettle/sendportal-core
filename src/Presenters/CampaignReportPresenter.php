...
class CampaignReportPresenter
{
    ...
    protected function getChartData()
    {
        ...
        $boundaries = $this->messageRepo->getFirstLastOpenedAt(currentTeamId(), Campaign::class, $this->campaign->id);
        ...
        $opensPerPeriod = $this->messageRepo->countUniqueOpensPerPeriod(currentTeamId(), Campaign::class, $this->campaign->id, $secondsPerInterval);
